import { Home, MessageSquare, Heart, User, Gift } from 'lucide-react';
...
export function BottomNav({ currentView = 'home', onHomeClick, onFavoritesClick, onProfileClick, onChatBotClick, onLuckyDrawClick }: BottomNavProps) {
  return (
      ...
      <div className="bg-white rounded-[28px] shadow-[0_-4px_20px_rgba(0,0,0,0.08)] border border-gray-100">
        <div className="flex items-center justify-around py-3 px-2">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 ${currentView === 'luckydraw' ? 'text-[#FAA935]' : 'text-gray-400'}`}
          >
            <Gift className={`w-6 h-6 ${currentView === 'luckydraw' ? 'fill-[#FAA935]' : ''}`} />
          </button>
